...
function calculateRatio(A,t){for(var e=t;1<e;e--)A%e==0&&t%e==0&&(A/=e,t/=e);return A+":"+t}const AF=Array.from,colonNumber=(A,e)=>A.filter((A,t)=>t<e).filter(A=>""!==A),getMonthFromString=A=>new Date(Date.parse(A+" 1, 2012")).getMonth()+1;class _Settings{A=!0;t=!0;o=!0;i=!0;g=!0;v=!0;l=!0;m=!0;B=!0;C=!0;I=!0;P=!1;u=!0;p;h(A,t){var e="sbe-setting-"+t.toString().replace(/\s/g,"_"),n=document.createElement("label"),A=(n.innerHTML=A+": ",n.setAttribute("for",e),document.createElement("input"));A.name=e,A.id=e,A.type="checkbox",
//@ts-ignore
A.checked=this[t]??!1,A.addEventListener("click",A=>{A=//@ts-ignore
A.target.checked;this[t]=A}),this.p?.appendChild(n),this.p?.appendChild(A),this.k()}k(){this.p?.appendChild(document.createElement("br"))}constructor(){this.H(),this.p=document.createElement("dialog");var A=document.createElement("h1"),A=(A.innerHTML="Skyblock Extras Settings",A.style.fontSize="2em",this.p.appendChild(A),this.k(),this.p.style.width="640px",this.p.style.height="480px",this.p.style.borderRadius="1em",this.p.style.border="none",this.p.style.outline="none",this.p.style.textAlign="center",this.h("Thread Title as Browser Title","threadTitleEnabled"),this.h("Remove the shop tab","hideShopTab"),this.h("Strike through banned users' names","strikethroughBannedUsers"),this.h("Better New Style Theme","betterNewSB"),this.h("Skyblock.onl Integration","SBonlIntegration"),this.h("Show actual date on threads on the frontpage","actualDateOnFrontpage"),this.h("Fix bedrock players' images","fixBedrockPlayersImages"),this.h("Responsive Modals","responsiveModals"),this.h("Move poking out of moderator tools","movePoke"),this.h("Add given:received ratio for reactions on profile","ratingRatio"),this.h("Remove commas from ratings","removeRatingCommas"),this.h("Avatar on profile stats.","avatarOnProfileStats"),this.h("Place birthday hats on birthday peoples' PFPs","birthdayHatOnPFP"),document.createElement("button")),A=(A.innerHTML="Save",A.style.width="6em",A.style.height="2.5em",A.addEventListener("click",A=>{this.S(),window.location.reload()}),this.k(),this.k(),this.p.appendChild(A),document.createElement("button")),A=(A.innerHTML="Close",A.style.width="6em",A.style.height="2.5em",A.addEventListener("click",A=>{this.close()}),this.k(),this.k(),this.k(),this.k(),this.p.appendChild(A),document.body.appendChild(this.p),document.createElement("img"));A.src=" data:image/png;base64,",A.id="sbe-settings-opener-img",A.style.marginLeft="9em",A.style.marginTop="2px",A.height=20,A.width=20,A.addEventListener("click",A=>{this.open()}),document.querySelector('[class="navTabs"]')?.insertBefore(A,document.querySelector(".visitorTabs"))}open(){this.p?.showModal()}close(){this.p?.close()}S(){localStorage.setItem("sbe-settings",JSON.stringify({A:this.A,t:this.t,o:this.o,i:this.i,g:this.g,v:this.v,l:this.l,m:this.m,B:this.B,C:this.C,I:this.I,P:this.P,u:this.u}))}H(){var A=JSON.parse(localStorage.getItem("sbe-settings")??"{}");for(const t of Object.keys(A))
//@ts-ignore
this[t]=A[t]}}const settings=new _Settings;if(document.querySelector(".navTabs")){const O=`
        .navTabs {
            position: relative;
        }
    ...
    `;GM_addStyle(O)}if(settings.A&&(document.title=(document.querySelector(".titleBar>h1")??document.querySelector('h1.username[itemprop="name"]'))?.textContent+" | Skyblock Forums"),settings.t){const P=document.querySelector("ul.publicTabs"),Q=P?.children[7],R=P?.children[6];Q&&R?.replaceWith(Q)}if(settings.o){const S=document.querySelectorAll(".messageUserBlock"),T=Array.from(S).filter(A=>A.querySelector('[src="styles/default/xenforo/avatars/avatar_banned_m.png"]')),U=`
        .sbe-strikethrough {
            text-decoration: line-through !important;
            text-decoration-thickness: 2px !important;
        }
    `;GM_addStyle(U),T.forEach(A=>{A.querySelector(".userText > .username")?.classList.add("sbe-strikethrough")})}if(settings.i){const X=`
    div.navTabs {
        background:#2b485c;
